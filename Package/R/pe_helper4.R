pe_helper4 <- function (rx=1, ry=0.2, mid=c(0,0), dr=0.01,
  ...
  xy<-gl_helper1 (rx,ry,mid,angle=angle,dr=dr,from=from,to=to)
  ...
  if (arrow) {
    ...
    for (i in 1: ilen) {
      ...
      a_helper3(xy[ii-1,1], xy[ii-1,2], xy[ii,1], xy[ii,2],
