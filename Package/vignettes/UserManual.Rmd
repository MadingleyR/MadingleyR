...
## Loading MadingleyR package

First we need to load to ```MadingleyR``` package. We can use ```madingley_version()``` to check the version of the R package as well as the C++ source code.
