...
m_params[28, 2] = 1-removal_fraction
...
pdf(paste0("~/Desktop/TempMadingleyOuts/env_",removal_fraction,"stabilization.pdf"))
...
plot(r, legend.only=TRUE, col=colorRampPalette(c("#e5f5e0","#31a354"))(20),
     legend.width=1, legend.shrink=0.75, legend.mar = 12,
     axis.args=list(at=seq(0,r_max,5), labels=seq(0,r_max,5), cex.axis=0.6),
     legend.args=list(text='Herbivores remaining (%)', side=4, font=2, line=2.5, cex=0.8))
dev.off()
