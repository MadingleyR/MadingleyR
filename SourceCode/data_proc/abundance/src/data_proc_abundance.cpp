...
{  
    ...
    //-----------------------------------------------------------------------------
        ...
        std::vector<double> CohortAbundance;
        std::vector<int> GridcellIndex;
        std::vector<int> FunctionalGroupIndex;
    ...
    //-----------------------------------------------------------------------------
        ...
        for (int i = 0; i < GridcellIndex.size(); i++) {
            ...
            temp_vec[index] += CohortAbundance[i];
        };
